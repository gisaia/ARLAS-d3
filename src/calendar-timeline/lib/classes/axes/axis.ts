...
import { DrawableObject, TimelineContext } from '../drawable.object';
...
export class Axis extends DrawableObject {
    ...
    public plot() {
        let axis = axisBottom(this.domain).ticks(this.tickInterval)
                                            .tickSize(this.tickSize);
        if (this.tickFormat) {
            axis = axis.tickFormat(this.tickFormat);
        }
