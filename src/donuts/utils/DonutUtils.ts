...
export class DonutUtils {
  ...
  public static getNodeColor(d: DonutNode, donutNodeColorizer: ColorGenerator | undefined,
  ...
  public static getNodeToolipAsArray(n: DonutNode, donutNodeColorizer: ColorGenerator | undefined,
